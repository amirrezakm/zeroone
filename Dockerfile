...
# Placeholder defaults. Set ORIGIN_HOST (and optionally WS_TARGET /
# XHTTP_TARGET) in the deploy environment to point at the real origin —
# any Docker host env var overrides these.
ENV ORIGIN_HOST=203.0.113.1 \
    WS_PATH=/vless \
